export const site = {
  ...
  syllabusCoverage: 'CBSE, ICSE & all major syllabi across India',
  email: 'info@mgtuition.com',
  // Update these when India numbers are confirmed
  phoneDisplay: '+91 98765 43210',
  phoneHref: 'tel:+919876543210',
  whatsappNumber: '919876543210',
  whatsappMessage: 'Hi, I would like to book a free trial class with MG Tuition India.',
  ...
  boards: [
    ...
    },
    {
      ...
      levels: 'Classes 1–12',
      description:
        'Support for major state syllabi across India — aligned to local textbooks, exam patterns, and board calendars.',
      topics: [
        'State board syllabus matched to your child\'s textbook',
        'SSLC, HSC & regional board exam preparation',
        'English and regional-medium options where needed',
        'Chapter-wise tests aligned to state exam schedules',
      ],
    },
  ],
  subjects: [
