...
import { ArrowRight, LogIn, Menu, Phone, UserPlus, X } from 'lucide-react'
...
function NavLoginButton({
  ...
  return (
    ...
    >
      ...
      <LogIn className="relative h-3.5 w-3.5 shrink-0 text-orange-400" />
            ...
            <>
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                {loading ? (
                  ...
                  <>
                    <NavLoginButton compact className="lg:hidden" />
                    <NavLoginButton className="hidden lg:inline-flex" />
                  </>
                )}
                {!loading && !user ? (
                  <NavSignupButton className="hidden sm:inline-flex" />
                ) : null}
                <button
                  type="button"
        ...
        {!dashboardView && mobileOpen ? (
          ...
          >
            <div className="flex flex-col gap-1">
              ...
              {!loading && !user ? (
                <NavSignupButton fullWidth className="mt-3" />
              ) : null}
            </div>
          </motion.div>
        ) : null}
