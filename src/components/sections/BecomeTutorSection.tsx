      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-start gap-6 text-white lg:flex-row lg:items-center lg:justify-between">
        ...
        >
          ...
          <p className="mt-3 text-white/80">
            Join a growing network of tutors delivering small-batch classes for CBSE, ICSE and Kerala
            boards — with training, scheduling support, and steady student demand.
          </p>
        </motion.div>
